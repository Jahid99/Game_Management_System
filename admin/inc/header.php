    ...
    <div class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><b>Player Management System - Admin Panel</b></a>
        </div>
         <?php 
          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown <?php if($currentpage=='addcat' || $currentpage=='catlist' || $currentpage=='editcat'){echo 'active';} ?>"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Category <span class="caret"></span></a>
